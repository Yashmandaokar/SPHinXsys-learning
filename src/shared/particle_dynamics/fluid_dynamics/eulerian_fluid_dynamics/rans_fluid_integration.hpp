...
namespace SPH
{
    namespace fluid_dynamics
    {
        ...
        EulerianIntegrationRANS<DataDelegationType>::EulerianIntegrationRANS(BaseRelationType& base_relation)
            ...
            Vol_(this->particles_->Vol_), Cmu_(0.09) {}
        //=================================================================================================//
        //=================================================================================================//
        ...
        EulerianIntegration1stHalfRANS<Inner<>, RiemannSolverType>::
            ...
            : EulerianIntegrationRANS<FluidDataInner>(inner_relation),
        ...
        void EulerianIntegration1stHalfRANS<Inner<>, RiemannSolverType>::interaction(size_t index_i, Real dt)
        {
            ...
            Matd meanvel_advection = Matd::Zero(); 
            ...
            for (size_t n = 0; n != inner_neighborhood.current_size_; ++n)
            {
                ...
                meanvel_advection = -1.0 * dW_ij * Vol_[index_j] * (interface_state.rho_ * interface_state.vel_ * interface_state.vel_.transpose());
                viscous_dissipation = (2.0 * (fluid_.ReferenceViscosity() + mu_t_[index_i]) * dW_ij * Vol_[index_j]) * interface_state.vel_ / r_ij;
                ...
                momentum_change_rate += Vol_[index_i] * (meanvel_advection - (interface_state.p_ + (2.0 / 3.0) * (K_[index_i] - K_[index_j])) * Matd::Identity()) * e_ij + viscous_dissipation;   
            }
        ...
        void EulerianIntegration1stHalfRANS<Inner<>, RiemannSolverType>::update(size_t index_i, Real dt)
        {
            ...
            if (vel_[index_i].norm() > 1000)
            {
                Vecd vel_i = vel_[index_i];
                Vecd mom_i = mom_[index_i];
                Vecd dmom_i = dmom_dt_[index_i];
                Vecd force_i = force_prior_[index_i];
                Real j = 1.0;
            }
        }
        //=================================================================================================//
