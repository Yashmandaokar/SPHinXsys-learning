/**
 * @file 	test_2d_eulerian_channelflow.cpp
 ...
 */
#include"test_2d_eulerian_channelflow.h"
using namespace SPH;
...
int main(int ac, char* av[])
{
    ...
    InteractionWithUpdate<fluid_dynamics::EulerianIntegration1stHalfWithWallRiemann> pressure_relaxation(water_block_inner, water_wall_contact);
