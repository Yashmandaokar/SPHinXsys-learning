 ...
 */
#include"turbulent_channelflow_eulerian.h"
#include "sphinxsys.h"
using namespace SPH;
...
int main(int ac, char *av[])
{
    ...
    wall_boundary.defineAdaptationRatios(1.3, 2.0);
    wall_boundary.sph_adaptation_->resetKernel<KernelTabulated<KernelLaguerreGauss>>(20);
    ...
    //----------------------------------------------------------------------
    InteractionDynamics<solid_dynamics::ViscousForceFromFluid> viscous_force_on_solid(wall_contact);
    InteractionDynamics<solid_dynamics::AllForceAccelerationFromFluid> fluid_force_on_solid_update(wall_contact, viscous_force_on_solid);
    //----------------------------------------------------------------------
