...
#include "Yash_2d_Turbulent_ChannelFlow.h"
#include "sphinxsys.h"
using namespace SPH;
//----------------------------------------------------------------------
...
int main(int ac, char *av[])
{
    ...
    SimpleDynamics<CFInitialCondition> initial_condition(water_block);
    ...
    InteractionWithUpdate<fluid_dynamics::EulerianIntegration1stHalfRANSNoRiemannSolver> pressure_relaxation(water_block_inner, 200.0);
    InteractionWithUpdate<fluid_dynamics::EulerianIntegration2ndHalfRANSNoRiemannSolver> density_relaxation(water_block_inner, 200.0);
    CFBoundaryConditionSetup boundary_condition_setup(water_block_inner, ghost_creation.each_boundary_type_with_all_ghosts_index_,
