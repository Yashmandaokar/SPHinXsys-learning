...
//----------------------------------------------------------------------
Real DL = 1; //0.769846;                            /**< Computation domain length. */
...
BoundingBox system_domain_bounds(Vec3d(-0.3, 0.0, 0.0), Vec3d(DL - 0.3, DH, DW));
//----------------------------------------------------------------------
//	Material properties of the fluid.
//----------------------------------------------------------------------
Real rho0_f = 1.0;                                     /**< Density. */
Real U_f = 1.0;                                          /**< freestream velocity. */
Real c_f = 34.72144187 * U_f;                                   /**< Speed of sound. */                                  
Real mu_f = 0;               /**< Dynamics viscosity. */
    ...
    : public fluid_dynamics::WeaklyCompressibleFluidInitialCondition
{
    ...
    explicit CFInitialCondition(SPHBody& sph_body)
        : WeaklyCompressibleFluidInitialCondition(sph_body), vel_(particles_->vel_)
    {};
