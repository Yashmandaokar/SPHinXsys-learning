 ...
 */
#ifndef UNSTRUCTURED_FLUENT_MESH_H
#define UNSTRUCTURED_FLUENT_MESH_H
 ...
 */
class readFluentMeshFile_3d
{
  public:
      readFluentMeshFile_3d(std::string full_path)
    {
        full_path_ = full_path;
        getDataFromFluentMeshFile3d();
        getFluentElementCenterCoordinates();
        getMinimumDistanceBetweenNodesFluent();
    };
    virtual ~readFluentMeshFile_3d(){};

    void getDataFromFluentMeshFile3d();
    void getFluentElementCenterCoordinates();
    void getMinimumDistanceBetweenNodesFluent();
    string full_path_;
...
class FluentParticleGeneratorInFVM : public ParticleGenerator
{
  public:
    explicit FluentParticleGeneratorInFVM(SPHBody &sph_body)
        : ParticleGenerator(sph_body){};
    FluentParticleGeneratorInFVM(SPHBody &sph_body, const StdLargeVec<Vecd> &positions, const StdLargeVec<Real> &elements_volumes);
    virtual ~FluentParticleGeneratorInFVM(){};
...
class GhostCreationFromFluentMesh : public GeneralDataDelegateSimple
{
  public:
      GhostCreationFromFluentMesh(RealBody &real_body, vector<vector<vector<size_t>>> &data_inpute, vector<vector<Real>> nodes_coordinates)
    ...
    virtual ~GhostCreationFromFluentMesh(){};
...
class BodyStatesRecordingInFluentMeshToVtu : public BodyStatesRecording
{
  public:
    BodyStatesRecordingInFluentMeshToVtu(IOEnvironment &io_environment, SPHBody &body, vector<vector<size_t>> elements_nodes_connection, vector<vector<Real>> nodes_coordinates)
    ...
    BodyStatesRecordingInFluentMeshToVtu(IOEnvironment &io_environment, SPHBodyVector bodies, vector<vector<size_t>> elements_nodes_connection, vector<vector<Real>> nodes_coordinates)
    ...
    virtual ~BodyStatesRecordingInFluentMeshToVtu(){};
...
#endif // UNSTRUCTURED_FLUENT_MESH_H