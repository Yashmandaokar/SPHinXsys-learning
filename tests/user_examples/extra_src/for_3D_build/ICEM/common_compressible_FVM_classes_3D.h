 ...
 */
class CompressibleAcousticTimeStepSizeInFVM_3D : public fluid_dynamics::AcousticTimeStepSize
{
  protected:
  ...
  public:
    explicit CompressibleAcousticTimeStepSizeInFVM_3D(SPHBody &sph_body, Real min_distance_between_nodes, Real acousticCFL = 0.6);
    virtual ~CompressibleAcousticTimeStepSizeInFVM_3D(){};
