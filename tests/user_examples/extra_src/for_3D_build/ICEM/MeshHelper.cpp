...
namespace SPH
{
    ...
    void MeshFileHelpers::nodeCoordinates(ifstream& mesh_file, size_t& node_index, vector<vector<Real>> &point_coordinates_3D_, string& text_line, size_t& dimension, vector<vector<Real>>& point_coordinates)
    {
        while (getline(mesh_file, text_line))
            {
    ...
    void MeshFileHelpers::dataStruct(vector<vector<vector<size_t>>>& cell_lists_, vector<vector<size_t>>& elements_nodes_connection_, size_t number_of_elements, size_t mesh_type, size_t dimension, StdLargeVec<Vec3d>& elements_neighbors_connection_)
    {
    ...
    void MeshFileHelpers::updateElementsNodesConnection(vector<vector<size_t>>& elements_nodes_connection_, Vecd nodes, Vec2d cells, bool& check_neighbor_cell1, bool& check_neighbor_cell2)
    {
    ...
    void MeshFileHelpers::updateCellLists(vector<vector<vector<size_t>>>& cell_lists_, vector<vector<size_t>>& elements_nodes_connection_, Vecd nodes, Vec2d cells, bool& check_neighbor_cell1, bool& check_neighbor_cell2, size_t boundary_type)
    {
    ...
    void MeshFileHelpers::cellCenterCoordinates(vector<vector<size_t>>& elements_nodes_connection_, std::vector<std::vector<long unsigned int>>::size_type& element, vector<vector<Real>>& point_coordinates_3D_, StdLargeVec<Vecd>& elements_center_coordinates_, Vecd& center_coordinate)
    {
    ...
    void MeshFileHelpers::elementVolume(vector<vector<size_t>>& elements_nodes_connection_, std::vector<std::vector<long unsigned int>>::size_type& element, vector<vector<Real>>& point_coordinates_3D_, StdLargeVec<Real>& elements_volumes_)
    {
        // get nodes position
        Real Total_volume = 0;
    ...
    void MeshFileHelpers::faceArea(vector<Real>& all_data_of_distance_between_nodes, StdLargeVec<Real>& elements_volumes_, vector<vector<vector<size_t>>>& cell_lists_, vector<vector<Real>>& point_coordinates_3D_)
    {
    ...
    void MeshFileHelpers::vtuFileNodeCoordinates(std::ofstream& out_file, vector<vector<Real>>& nodes_coordinates_, vector<vector<size_t>>& elements_nodes_connection_)
    {
        // Write point data
