...
int main(int ac, char *av[])
{
	...
	vapor_block.defineParticlesAndMaterial<BaseParticles, WeaklyCompressibleFluid>(rho0_v, c_f,mu_air);
	...
	InteractionWithUpdate<fluid_dynamics::DensitySummationFreeSurfaceComplex> update_water_density_by_summation(water_wall_contact, water_vapor_complex.getInnerRelation());
	InteractionWithUpdate<fluid_dynamics::DensitySummationComplex> update_vapor_density_by_summation(vapor_wall_contact,vapor_water_complex);
	InteractionDynamics<fluid_dynamics::TransportVelocityCorrectionComplex> vapor_transport_correction(vapor_wall_contact,vapor_water_complex);
